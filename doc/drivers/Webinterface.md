...
* Adjust nph-png to contain the path/filename of the output file (s. -o option
  in [Raster.md][Raster.md] or `lcd4linux -h`).
...
Note: depending on your web server's configuration, you must rename nph-png to
