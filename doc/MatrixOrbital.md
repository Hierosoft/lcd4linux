...
signal of the RS-232 port. I chose the latter, and modified a serial card so that it supplies
...
all bar types can be used simultaneously. As the displays only have 8 user-defined characters,
