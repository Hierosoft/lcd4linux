...
* Port: serial device (i.e. ttyS0) the LCD module is connected to.
* Speed: any of 1200, 2400, 9600 and 19200.
  * By default, the driver uses 9600 which is the speed the LCD modules are hardwired at.
  * If your module works at a different speed than 9600, use this parameter.
    Otherwise omit it (i.e. omit it when you have a 634).

* Backlight: controls the backlight brightness.
  * Quote from 634.pdf from the Crystalfonts-Webserver[1]:
    * "0=OFF
    * 100=ON.
    * Intermediate values vary the brightness.
    * There are a total of 25 possible brightness levels."
* Contrast: controls the contrast settings. Quote[1]:
  * "0=very light,
  * 100 = very dark.
  * 50 is typical.
